...
- Add the following to the end of the file (be careful with your indentation):
 ...
 {{% code file="reInvent2019/400-task-4/artefacts/version_only.yaml" language="yaml" %}}
 
- Verify the contents of your file matches this:

 {{% code file="reInvent2019/400-task-4/artefacts/product_and_version.yaml" language="yaml" %}}
