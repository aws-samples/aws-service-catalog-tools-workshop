...
#### Add the product to the framework
...
- Add the following to the products section (be careful with your indentation):
 ...
 {{% code file="50-reInvent2019/200-task-2/artefacts/factory/create-the-product--product-only.yaml" language="js" %}}
 
- The whole input should look like this:

{{% code file="50-reInvent2019/200-task-2/artefacts/factory/create-the-product--product.yaml" language="js" %}}
