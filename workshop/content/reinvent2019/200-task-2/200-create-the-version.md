...
- Add the following to product you just added (be careful with your indentation):
 ...
 {{% code file="reInvent2019/200-task-2/artefacts/factory/create-the-version--version-only.yaml" language="js" %}}
 
- Verify the contents of your file matches this:

 {{% code file="reInvent2019/200-task-2/artefacts/factory/create-the-version--product_and_version.yaml" language="js" %}}
