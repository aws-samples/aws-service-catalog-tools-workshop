...
- Add the following to the products section (be careful with your indentation):
 ...
 {{% code file="reInvent2019/400-task-4/artefacts/factory/create-the-product--product-only.yaml" language="js" %}}
 
- The whole input should look like this:

{{% code file="reInvent2019/400-task-4/artefacts/factory/create-the-product--product.yaml" language="js" %}}
