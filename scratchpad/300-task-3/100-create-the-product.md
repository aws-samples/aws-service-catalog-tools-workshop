...
- Add the following to the products section (be careful with your indentation):
 ...
 {{% code file="40-reinvent2019/300-task-3/artefacts/factory/create-the-product--product-only.yaml" language="js" %}}
 
- The whole input should look like this:

{{% code file="40-reinvent2019/300-task-3/artefacts/factory/create-the-product--product.yaml" language="js" %}}
